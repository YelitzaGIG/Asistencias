# DGETI — Sistema de Justificantes
## Versión 1.0.0 | PHP MVC | CETIS 193
...
2. **Crear la base de datos** — abre phpMyAdmin o MySQL CLI y ejecuta:
   ```sql
...
> Los usuarios demo están en `app/models/UserModel.php`.  
> Para producción, crea una tabla `users` en la BD y conecta el modelo.
