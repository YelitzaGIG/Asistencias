-- ============================================================
-- SISTEMA DE JUSTIFICANTES DE ALUMNOS
...
-- ============================================================
-- TABLA: justificantes
-- Almacena todos los justificantes generados por alumnos
-- ============================================================
CREATE TABLE IF NOT EXISTS justificantes (
    id              INT(11)         NOT NULL AUTO_INCREMENT,
    folio           VARCHAR(10)     NOT NULL UNIQUE,       -- Folio único, ej: JUS-0001
    nombre_alumno   VARCHAR(150)    NOT NULL,              -- Nombre completo del alumno
    grupo           VARCHAR(20)     NOT NULL,              -- Grupo del alumno, ej: 3A, ISC-401
    numero_control  VARCHAR(20)     NOT NULL,              -- Número de control institucional
    motivo          ENUM('Salud','Comisión','Personal') NOT NULL,  -- Tipo de justificante
    fecha           DATE            NOT NULL,              -- Fecha de generación del justificante
    estado          ENUM('Generado','Entregado','Validado') NOT NULL DEFAULT 'Generado', -- Estado actual
